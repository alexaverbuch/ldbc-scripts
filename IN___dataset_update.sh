...
validation_set_dir=${connector_dir}/data-import/src/test/resources/validation_sets/interactive/neo4j
...
mv ${parameters_dir}/query_* ${validation_set_dir}/substitution_parameters/
mv ${hadoop_dir}/updateStream* ${validation_set_dir}/updates/
mv ${hadoop_dir}/* ${validation_set_dir}/social_network/string_date/
...
rm ${hadoop_dir}/updateStream*
mv ${hadoop_dir}/* ${validation_set_dir}/merge/social_network/string_date/
...
rm ${hadoop_dir}/updateStream*
mv ${hadoop_dir}/* ${validation_set_dir}/social_network/num_date/
...
# --- COPY MERGE STRING DATE files to connector ---
rm ${hadoop_dir}/updateStream*
mv ${hadoop_dir}/* ${validation_set_dir}/merge/social_network/num_date/
